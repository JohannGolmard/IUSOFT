public class Darkness extends Demonic{
	...
	public Darkness(int soulCost, int neededSanity, int neededResistance, int neededIntelligence, int health, int attack, int defense, String trigger, String type) {
